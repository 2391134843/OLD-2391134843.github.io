...
## Demo样式演示：
![](http://p8i28834i.bkt.clouddn.com/Demo1.png)
![](http://p8i28834i.bkt.clouddn.com/Demo2.png)
![](http://p8i28834i.bkt.clouddn.com/Demo3.png)
## 实现思路
 两个前端页面，一个是注册页面，一个登录页面，设置一个Javabean对象来存储这些数据。
注册：
将注册页面中填的信息封装成Javabean插入到已经建好student数据表中。判断该用户是否存在，如果用户存在则显示该用户已经存在。
![](http://p8i28834i.bkt.clouddn.com/Demo-Register.png)
登录：
将页面中传过来的参数与数据库中的信息匹配，如果用户名和密码都匹配成功则说命用户存在并且登陆成功。如果账号或者密码错误则登录失败
![](http://p8i28834i.bkt.clouddn.com/Demo-Login.png)
## 源代码展示
